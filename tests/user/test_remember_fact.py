...
class TestRememberFact:
    ...
    def test_fact_recalled_in_conversation(self, cca, trace_test, judge_model):
        ...
        try:
            ...
            message = (
                f"Hey {name} here. Can you remind me what company "
                f"I work at? And also show me how to do a health "
                f"check in Python."
            )
    ...
    def test_fact_overwrite(self, cca, trace_test, judge_model):
        ...
        try:
            ...
            assert has_new, (
                ...
                f"'{new_company}': {result.content[:300]}"
            )
        finally:
            cca.cleanup_test_user(name)
    ...
    def test_fact_persists_across_sessions(self, cca, trace_test, judge_model):
        ...
        try:
            ...
            cca.chat(
                ...
                f"Write a Python one-liner to check if a string "
                f"is a palindrome.",
                session_id=sid1,
            )
